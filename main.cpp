...
void initializeLayers(std::mt19937& rng, MachineLearning::Model& model) {
    ...
    std::vector<std::shared_ptr<MachineLearning::Layer>> layers(1 + 4 + 1);
    layers.at(0) = std::make_shared<MachineLearning::Layer>(28*28);
    layers.at(1) = std::make_shared<MachineLearning::Layer>(128);
    layers.at(2) = std::make_shared<MachineLearning::Layer>(128);
    layers.at(3) = std::make_shared<MachineLearning::Layer>(64);
    layers.at(4) = std::make_shared<MachineLearning::Layer>(64);
